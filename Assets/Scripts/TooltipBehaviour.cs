...
public class TooltipBehaviour : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        tooltipUIInstance.sizeDelta = new Vector2(30 * TooltipText.Length, tooltipUIInstance.sizeDelta.y);
        tooltipUIInstance.localPosition = new Vector3(12.5f * TooltipText.Length + 50, -75, 0);
